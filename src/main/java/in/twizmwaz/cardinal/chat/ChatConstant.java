...
public enum ChatConstant {
    ...
    GENERIC_START_COUNTDOWN_CANELLED("generic.startCountdownCancelled"),
    GENERIC_CYCLE_COUNTDOWN_CANELLED("generic.cycleCountdownCancelled"),
    GENERIC_COUNTDOWN_CANELLED("generic.countdownCancelled"),
    GENERIC_NO_COUNTDOWNS("generic.noCountdowns"),
