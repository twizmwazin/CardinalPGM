...
public class MobModuleBuilder implements ModuleBuilder {
    ...
    public ModuleCollection load(Match match) {
        ...
        if (match.getDocument().getRootElement().getChild("mob") != null) {
            results.add(new MobModule(FilterModuleBuilder.getFilter(match.getDocument().getRootElement().getChild("mob").getChild("filter"))));
