    ...
    public String getPrefix(TeamModule team) {
        ...
        if (objective instanceof WoolObjective) {
            ...
            if (wool.isComplete()) {
                ...
                prefix = MiscUtils.convertDyeColorToChatColor(wool.getColor()) + " \u2B1C " + ChatColor.RESET + NumUtils.convertToSubscript(wool.getProximity() == Double.POSITIVE_INFINITY || wool.getProximity() == Double.NEGATIVE_INFINITY ? wool.getProximity() : Math.round(wool.getProximity() * 10.0) / 10.0) + " ";
            } else {
                prefix = MiscUtils.convertDyeColorToChatColor(wool.getColor()) + " \u2B1C ";
            }
            ...
            if (core.isComplete()) {
                ...
                prefix = ChatColor.RED + " \u2715 " + ChatColor.RESET + NumUtils.convertToSubscript(core.getProximity() == Double.POSITIVE_INFINITY || core.getProximity() == Double.NEGATIVE_INFINITY ? core.getProximity() : Math.round(core.getProximity() * 10.0) / 10.0) + " ";
            } else {
            ...
            if (destroyable.showPercent()) {
                if (destroyable.isComplete()) {
                    ...
                    prefix = ChatColor.RED + " " + destroyable.getPercent() + "% " + ChatColor.RESET + NumUtils.convertToSubscript(destroyable.getProximity() == Double.POSITIVE_INFINITY || destroyable.getProximity() == Double.NEGATIVE_INFINITY ? destroyable.getProximity() : Math.round(destroyable.getProximity() * 10.0) / 10.0) + " ";
                } else {
                ...
                if (destroyable.isComplete()) {
                    ...
                    prefix = ChatColor.RED + " \u2715 " + ChatColor.RESET + NumUtils.convertToSubscript(destroyable.getProximity() == Double.POSITIVE_INFINITY || destroyable.getProximity() == Double.NEGATIVE_INFINITY ? destroyable.getProximity() : Math.round(destroyable.getProximity() * 10.0) / 10.0) + " ";
                } else {
                    prefix = ChatColor.RED + " \u2715 ";
                }
            }
