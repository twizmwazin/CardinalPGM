...
public class ClassModule implements Module {
    ...
    protected ClassModule(final String name, final String description, final String longDescription, final Material icon, final boolean sticky, final boolean defaultClass, final boolean restrict, final KitCollection kit) {
        this.name = name;
